<?php
$sInitialBN="আজ ও কাল";
$sInitialEN="AajOKal.com";
$sSiteName="AajOKal.com";
$sSiteTitle="আজ ও কাল :: AajOKal.com";
$sAuthor="AajOKal.com";
$sDeveloper="eMythMakers.com";
$sEmail="info@123.com";
$sMobile="+88-56820000000000";


//Local
$sSiteURL="http://localhost/AajOKal/";
$sCurrURL="http://localhost/AajOKal/".$_SERVER["REQUEST_URI"];

//Web
// $sSiteURL="https://www.emythmaker.com/project/Template/NewsProtal/AajOKal/";
// $sCurrURL="https://www.emythmaker.com/project/Template/NewsProtal/AajOKal/".$_SERVER["REQUEST_URI"];
...
$sLogoURLFooter=$sSiteURL."media/common/fav.png";
$sLogoURLfb=$sSiteURL."media/common/logo-fb.png";
$sFavicon=$sSiteURL."media/common/favicon.ico.png";
